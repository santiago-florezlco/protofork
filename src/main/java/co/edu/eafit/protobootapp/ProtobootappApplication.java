...
public class ProtobootappApplication {
    ...
    @GetMapping("/")
    public String index() {
        return String.format("Bienvenido! Esta aplicación ayuda a elevar números cualquiera a sus potencias, Estudiantes, Juan Camilo Echavarria, Tatiana Cartagena, Santiago Florez.");
    }    
